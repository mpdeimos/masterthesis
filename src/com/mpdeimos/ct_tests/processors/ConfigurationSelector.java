...
public class ConfigurationSelector extends ConQATProcessorBase {

	private CDConfiguration config;

	/** {@ConQAT.Doc} */
	@AConQATParameter(name = "config", minOccurrences = 1, description = "Database.")
	public void setFile(
			@AConQATAttribute(name = "ref", description = "The database connection.") CDConfiguration connection) {
		this.config = connection;
	}

	/** {@inheritDoc} */
	@Override
	public CDConfiguration process() throws ConQATException {
		return this.config;
	}
